...
WERKWIJZE = '''<section class="section werkwijze">
  <div class="container">
    ...
    <ol class="steps" style="list-style:none; padding:0; margin:0;">
      <li class="step"><div class="num-lbl">— 01</div><div class="ic-circle"><img src="/design-assets/icons/icon-phone.svg" alt="" /></div><h3>Contact &amp; intake</h3><p>U vult het formulier in of belt. Binnen één werkdag bellen we terug.</p></li>
      <li class="step"><div class="num-lbl">— 02</div><div class="ic-circle"><img src="/design-assets/icons/icon-adviesgesprek-op-locatie.svg" alt="" /></div><h3>Adviesgesprek</h3><p>Een ervaren adviseur komt vrijblijvend bij u langs.</p></li>
      <li class="step"><div class="num-lbl">— 03</div><div class="ic-circle"><img src="/design-assets/icons/icon-bouwkundige-inmeting.svg" alt="" /></div><h3>Inmeting &amp; offerte</h3><p>Bouwkundige opname op de millimeter. Vaste offerte zonder kleine letters.</p></li>
      <li class="step"><div class="num-lbl">— 04</div><div class="ic-circle"><img src="/design-assets/icons/icon-def-akkoord.svg" alt="" /></div><h3>Productie</h3><p>Uw kozijnen worden op maat geproduceerd. Doorlooptijd 4–6 weken.</p></li>
      <li class="step"><div class="num-lbl">— 05</div><div class="ic-circle"><img src="/design-assets/icons/Icon-opdracht-ingediend.svg" alt="" /></div><h3>Montage &amp; oplevering</h3><p>Eigen monteurs plaatsen in 1 à 2 dagen — schoon opgeleverd.</p></li>
    </ol>
  </div>
</section>'''
    ...
    <div class="hero-grid">
      <div>
        ...
        <div class="hero-trust">
          ...
          <span class="sep">|</span>
          <span>Schüco &amp; Aluplast · KOMO · 10 jaar garantie</span>
        </div>
      </div>
...
def trust_badges_compact():
    """Compacte trust-strip voor dienstpagina's — direct onder breadcrumb."""
    return '''<section class="trust-badges trust-badges--compact" aria-label="Certificeringen en kwaliteitsbewijzen">
  <div class="container">
    <ul class="trust-row" role="list">
      <li class="trust-badge">
        <span class="badge-shape badge-shape--shield" aria-hidden="true"><svg viewBox="0 0 64 64" width="40" height="40" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"><path d="M32 6 8 14v22c0 12 10 20 24 24 14-4 24-12 24-24V14L32 6Z"/><path d="m22 32 7 7 14-14" stroke-width="3.5" stroke-linecap="round"/></svg></span>
        <span class="badge-label"><strong>KOMO</strong><span>Gecertificeerd profiel</span></span>
      </li>
      <li class="trust-badge">
        <span class="badge-shape badge-shape--lock" aria-hidden="true"><svg viewBox="0 0 64 64" width="40" height="40" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"><rect x="14" y="28" width="36" height="28" rx="3"/><path d="M22 28v-8a10 10 0 0 1 20 0v8" stroke-linecap="round"/><circle cx="32" cy="42" r="3" fill="currentColor"/></svg></span>
        <span class="badge-label"><strong>SKG ★★</strong><span>Inbraakwerend RC2</span></span>
      </li>
      <li class="trust-badge">
        <span class="badge-shape badge-shape--star" aria-hidden="true"><svg viewBox="0 0 64 64" width="40" height="40" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"><circle cx="32" cy="32" r="26"/><path d="M32 16v32M16 32h32" stroke-linecap="round"/></svg></span>
        <span class="badge-label"><strong>Schüco &amp; Aluplast</strong><span>Twee premium lijnen</span></span>
      </li>
      <li class="trust-badge">
        <span class="badge-shape badge-shape--house" aria-hidden="true"><svg viewBox="0 0 64 64" width="40" height="40" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"><path d="M8 28 32 8l24 20"/><path d="M14 28v28h36V28"/><path d="M20 38h24M20 46h24" stroke-linecap="round"/></svg></span>
        <span class="badge-label"><strong>Keralit</strong><span>10 jaar garantie</span></span>
      </li>
      <li class="trust-badge">
        <span class="badge-shape badge-shape--google" aria-hidden="true"><svg viewBox="0 0 64 64" width="40" height="40" fill="none" stroke="currentColor" stroke-width="3" stroke-linejoin="round"><path d="m32 8 7 17 18 1.5-13.8 12 4.3 18L32 47l-15.5 9.5 4.3-18L7 26.5 25 25l7-17Z" fill="currentColor" stroke="none"/></svg></span>
        <span class="badge-label"><strong>4,9 / 5</strong><span>Google reviews</span></span>
      </li>
    </ul>
  </div>
</section>'''
...
def specs_section(rows, source=None):
  ...
  <div class="container">
    <div class="section-head">
      ...
      <p>Geverifieerde productspecificaties. Wij werken alleen met premium materialen en kunnen op verzoek aangepaste uitvoeringen leveren.</p>
    </div>
...
PAGES = {
    ...
    'kunststof-deuren': {
        ...
        'data': {
            ...
            'specs': [
                ('Profielsysteem', '<strong>Schüco LivIng</strong> (deurkozijn)'),
                ('Montagebasis', '<strong>Kunststof stelkozijn</strong> — maatvast en vochtbestendig'),
    ...
    'kunststof-schuifpuien': {
        'label': 'Schuifpuien',
        'data': {
            'title': 'Kunststof schuifpuien op maat | Duurkracht',
            ...
            'specs': [
                ...
                ('Montagebasis', '<strong>Kunststof stelkozijn</strong> — stabiele basis voor brede glaspartijen'),
    ...
    'kunststof-gevelbekleding': {
        ...
        'data': {
            'title': 'Keralit gevelbekleding op maat | Duurkracht',
    ...
    'montage': {
        'label': 'Montage',
        'data': {
            'title': 'Kunststof stelkozijn montage | Duurkracht Kozijnen',
            'description': 'Schüco LivIng kozijnen laten plaatsen op kunststof stelkozijnen. Geen compriband als dragende basis, maar maatvaste montage door eigen monteurs.',
            'service_name': 'Kunststof stelkozijn montage',
            'service_desc': 'Vakkundige plaatsing van Schüco LivIng kunststof kozijnen op kunststof stelkozijnen. Geen compriband als dragende montagebasis, maar een maatvaste en vochtbestendige basis achter het kozijn.',
            ...
            'hero_eyebrow': 'Kunststof stelkozijn montage',
            'h1': 'De basis achter het kozijn maakt <span class="em-italic">het verschil.</span>',
            'lead': 'Wij plaatsen Schüco LivIng kozijnen op <strong>kunststof stelkozijnen</strong>. Niet op compriband als dragende basis, maar op een maatvast frame dat vochtbestendig is en jarenlang strak blijft.',
            'usp': ['Kunststof stelkozijnen', 'Geen compriband als basis', 'Schüco LivIng passend geplaatst', 'Eigen monteurs', 'Strakke afwerking', '10 jaar garantie'],
            'stats': [
            ...
            'intro_eyebrow': 'Waarom kunststof stelkozijnen?',
            'intro_h2': 'Een kunststof stelkozijn is de <span class="em-italic">fundering</span> van uw kozijn.',
            'intro_paragraphs': [
                'Een kunststof stelkozijn is het maatvaste frame dat eerst in de muuropening wordt geplaatst. Daarna komt het Schüco LivIng kozijn daarin. Zo ontstaat een stabiele, vochtbestendige basis achter de zichtbare afwerking.',
                'Compriband kan een voeg afdichten, maar is bij Duurkracht niet de dragende montagebasis. Kunststof stelkozijn-montage is standaard onderdeel van onze kwaliteitsbelofte.',
            ],
            'intro_checklist': [
                '<strong>Kunststof stelkozijn als basis</strong> voor elk kozijn',
                '<strong>Geen compriband als dragende oplossing</strong>',
                '<strong>Eigen monteurs</strong> met jarenlange ervaring',
                '<strong>KOMO-conforme</strong> werkwijze',
                '<strong>Luchtdichte en waterdichte aansluiting</strong>',
            ...
            'benefits': [
                ...
                ('Kunststof stelkozijn standaard', 'Wij zien het als basisvoorwaarde voor een strakke en vochtbestendige plaatsing.'),
            ...
            'faq_html': [
                ('Waarom werken jullie met kunststof stelkozijnen?', '<p>Een <strong>kunststof stelkozijn</strong> is de vaste basis achter het zichtbare kozijn. Het is maatvast en vochtbestendig, waardoor het Schüco LivIng kozijn strak geplaatst kan worden en de aansluiting beter controleerbaar blijft.</p>'),
                ('Wat is het verschil met compriband montage?', '<p>Compriband is een afdichtingsband die uitzet in een voeg. Dat kan nuttig zijn voor afdichting, maar het is geen stevige bouwkundige basis. Bij Duurkracht is het kunststof stelkozijn de montagebasis; afdichting komt daarna pas.</p>'),
                ...
                ('Geven jullie garantie op de montage?', '<p>Ja. Wij geven <strong>10 jaar garantie</strong> op zowel het Schüco LivIng kozijn als de montage zelf. Mocht er onverhoopt iets niet goed zijn, dan komen wij dit kosteloos verhelpen.</p>'),
            ],
            'faq': [
                ('Waarom werken jullie met kunststof stelkozijnen?', 'Een kunststof stelkozijn is de vaste basis achter het zichtbare kozijn. Het is maatvast en vochtbestendig, waardoor het Schüco LivIng kozijn strak geplaatst kan worden.'),
                ('Wat is het verschil met compriband montage?', 'Compriband is vooral afdichting. Een kunststof stelkozijn is de montagebasis waarin het kozijn wordt geplaatst.'),
